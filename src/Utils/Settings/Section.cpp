...
Section::Section(Section& section) : 
    StateFull(section.getRefTransform()), id(section.id), width(section.width), rate(section.rate), up(section.up), down(section.down), link_length(section.link_length), parallel_transform(section.parallel_transform), parallel_angle(section.parallel_angle)
{}
