...
namespace Geometry {
    ...
    FLOATU DegToRad(FLOATU deg);

    // RadToDeg
    // Converts radians to degrees.
    FLOATU RadToDeg(FLOATU rad);
    ...
    FLOATU ArcLengthOfMeridian (FLOATU phi);
    ...
    FLOATU UTMCentralMeridian(int zone);
    ...
    FLOATU FootpointLatitude(FLOATU y);
    ...
    void MapLatLonToXY (FLOATU phi, FLOATU lambda, FLOATU lambda0, FLOATU &x, FLOATU &y);
    ...
    void MapXYToLatLon (FLOATU x, FLOATU y, FLOATU lambda0, FLOATU& phi, FLOATU& lambda);
    ...
    int LatLonToUTMXY (FLOATU lat, FLOATU lon, int zone, FLOATU& x, FLOATU& y);
    ...
    // Returns:
    // The function does not return a value.
    void UTMXYToLatLon (FLOATU x, FLOATU y, int zone, bool southhemi, FLOATU& lat, FLOATU& lon);
...
// DegToRad
// Converts degrees to radians.
inline FLOATU Ilvo::Utils::Geometry::DegToRad(FLOATU deg) {
return (deg / 180.0 * pi);
}
...
// RadToDeg
// Converts radians to degrees.
inline FLOATU Ilvo::Utils::Geometry::RadToDeg(FLOATU rad) {
return (rad / pi * 180.0);
}
...
// Returns:
//     The ellipsoidal distance of the point from the equator, in meters.
inline FLOATU Ilvo::Utils::Geometry::ArcLengthOfMeridian (FLOATU phi) {
FLOATU alpha, beta, gamma, delta, epsilon, n;
FLOATU result;
...
//   The central meridian for the given UTM zone, in radians
//   Range of the central meridian is the radian equivalent of [-177,+177].
inline FLOATU Ilvo::Utils::Geometry::UTMCentralMeridian(int zone) {
FLOATU cmeridian;
cmeridian = DegToRad(-183.0 + ((FLOATU)zone * 6.0));
...
// Returns:
//   The footpoint latitude, in radians.
inline FLOATU Ilvo::Utils::Geometry::FootpointLatitude(FLOATU y) {
FLOATU y_, alpha_, beta_, gamma_, delta_, epsilon_, n;
FLOATU result;
...
// Returns:
//    The function does not return a value.
inline void Ilvo::Utils::Geometry::MapLatLonToXY (FLOATU phi, FLOATU lambda, FLOATU lambda0, FLOATU &x, FLOATU &y) {
    FLOATU N, nu2, ep2, t, t2, l;
    FLOATU l3coef, l4coef, l5coef, l6coef, l7coef, l8coef;
    //FLOATU tmp; // Unused
...
//   x1frac, x2frac, x2poly, x3poly, etc. are to enhance readability and
//   to optimize computations.
inline void Ilvo::Utils::Geometry::MapXYToLatLon (FLOATU x, FLOATU y, FLOATU lambda0, FLOATU& phi, FLOATU& lambda)
{
FLOATU phif, Nf, Nfpow, nuf2, ep2, tf, tf2, tf4, cf;
FLOATU x1frac, x2frac, x3frac, x4frac, x5frac, x6frac, x7frac, x8frac;
FLOATU x2poly, x3poly, x4poly, x5poly, x6poly, x7poly, x8poly;
...
// Returns:
//   The UTM zone used for calculating the values of x and y.
inline int Ilvo::Utils::Geometry::LatLonToUTMXY (FLOATU lat, FLOATU lon, int zone, FLOATU& x, FLOATU& y) {
if ( (zone < 1) || (zone > 60) )
...
// Returns:
// The function does not return a value.
inline void Ilvo::Utils::Geometry::UTMXYToLatLon (FLOATU x, FLOATU y, int zone, bool southhemi, FLOATU& lat, FLOATU& lon) {
FLOATU cmeridian;
